...
export const CarInfoCards: React.FC<CarInfoCardsProps> = ({
    ...
    return (
        <>
            ...
            <Section>
                <SectionTitle>
                    <BuildIcon sx={{ fontSize: 16, color: '#0071e3' }} />
                    {t('lastService')} & {t('serviceEvery')}
                </SectionTitle>
                <InfoGrid>
                    <DetailItem>
            ...
            <Section>
                <SectionTitle>
                    <EventIcon sx={{ fontSize: 16, color: '#0071e3' }} />
                    VTV & {t('extintor')}
                </SectionTitle>
                <InfoGridSecondRow>
                    <DetailItem>
                        ...
                        {vtvExpired ? (
                            ...
                            <DetailValue style={{ 
                                ...
                                {car.vtv_date ? `${formatDate(car.vtv_date)} - ${getTimeRemaining(car.vtv_date)}` : '-'}
                            </DetailValue>
                        )}
                    </DetailItem>
                    <DetailItem>
                        ...
                        {extintorExpired ? (
                            ...
                            <DetailValue style={{ 
                                ...
                                {car.extintor_date ? `${formatDate(car.extintor_date)} - ${getTimeRemaining(car.extintor_date)}` : '-'}
                            </DetailValue>
                        )}
                    </DetailItem>
                </InfoGridSecondRow>
